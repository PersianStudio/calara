/**
 * Slide-over calendar drawer with tab switcher, filters, and embedded board.
 */
...
import { DsCalendarBoard, type DsCalendarBoardProps } from '../CalendarBoard';
    ...
    <div className="calara calara-drawer-root" hidden={!open}>
      ...
      <div className="calara-drawer__panel" role="dialog" aria-modal="true" aria-label={title}>
        ...
        <div className="calara-drawer__body">
          ...
          <div className="calara-event__meta">{formatDate(currentDate, 'EEEE, MMMM d, yyyy')}</div>
        </div>
